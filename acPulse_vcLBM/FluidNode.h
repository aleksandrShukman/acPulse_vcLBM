...
public:
	//!constructor
	FluidNode() : Node() { tag_ = "fluid"; ID_ = 0; } //!standard

	FluidNode(double x, double y, double z, int indexI, int indexJ, int indexK, int level) : Node(x, y, z, indexI, indexJ, indexK, level)
	{
		tag_ = "fluid";
		ID_ = 0;
	}
